...
The purpose of this branch is to have an ActiveRecord 2.0.x compatible version with as many bug fixes as possible. In the future, the 1.x version *may* be made compatible with AR < 2.2 and 2.1. If so, this branch can go down forever.

FYI the last tagged release from this branch is v0.1.9 and soon a v0.1.10 will be out.
